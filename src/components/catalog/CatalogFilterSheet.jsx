  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center lg:items-center">
      ...
      <div
        ...
        className="filter-sheet-panel relative z-10 flex max-h-[92vh] w-full max-w-lg flex-col lg:max-h-[85vh]"
      >
        ...
        {loading && !facets ? (
          ...
          <div className="flex-1 space-y-3 overflow-y-auto px-4 py-4">
            <FilterSection
              title="ซีรีส์"
              hint="เลือกแบรนด์หรือไลน์นาฬิกา"
            >
